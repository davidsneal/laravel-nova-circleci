...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    deploy: function deploy() {
      ...
      Nova.request('/nova-vendor/laravel-nova-circleci/deploy').then(function () {
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _c("div", { staticClass: "flex items-center w-full p-4" }, [
                ...
                _vm._v(" "),
                _c("button", {
                  staticClass: "float-right btn btn-default btn-primary",
                  class: {
